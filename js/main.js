...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const defaultWaMessage = "Olá! Vim pelo site de vocês e gostaria de mais informações.";

  // Load centralized links and populate wa-link anchors
    ...
    .then((links) => {
      ...
      document.querySelectorAll('a.wa-link').forEach((a) => {
        ...
        a.addEventListener('click', function (e) {
          e.preventDefault();
          const url = waBase + '?text=' + encodeURIComponent(defaultWaMessage);
          window.open(url, '_blank', 'noopener');
        });
      });
    })
    .catch(() => {
      // fallback: no centralized link available
    });
=======
document.addEventListener("DOMContentLoaded", () => {
  const navbar = document.querySelector(".navbar");
...
>>>>>>> 1223125406864aec5e42007f1ec54f5331f9d80e
});